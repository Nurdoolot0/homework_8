...
public class RPG_Game {
    ...
    public static void startGame() {
        ...
        Ludoman ludoman = new Ludoman(250, 20, "Kostya");
        Hacker hacker = new Hacker(200,10,"Anonimous", 45);
        Hero[] heroes = {warrior1, warrior2, magic, doc, berserk, assistant, ludoman, hacker};
